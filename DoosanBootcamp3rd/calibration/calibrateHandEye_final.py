...
if __name__ == "__main__":
    # 캘리브레이션 데이터 로드
    # data = json.load(open("/home/rokey4090/ros2_ws/src/doosan-robot2/dsr_rokey/rokey/rokey/basic/data/calibrate_data.json"))
    data = json.load(open("/home/rokey/ros2_ws/src/DoosanBootcamp3rd/calibration/data/calibrate_data.json"))
